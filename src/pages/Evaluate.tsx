...
export function Evaluate() {
  return (
    <div className="pt-20">
     <Head>
        <title>Free Profile Evaluation | Elite Admissions Consulting</title>
        ...
        <meta property="og:title" content="Free Profile Evaluation | Elite Admissions Consulting" />
        ...
        <meta property="twitter:title" content="Free Profile Evaluation | Elite Admissions Consulting" />
