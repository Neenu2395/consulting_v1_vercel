...
export function Founders() {
  ...
  return (
    <div className="pt-20">
      <Head>
        <title>The Founders | HEC Paris & SDA Bocconi Alumni - Elite Admissions Consulting</title>
        ...
        <meta property="og:title" content="The Founders | HEC Paris & SDA Bocconi Alumni - Elite Admissions Consulting" />
        ...
        <meta property="twitter:title" content="The Founders | HEC Paris & SDA Bocconi Alumni - Elite Admissions Consulting" />
