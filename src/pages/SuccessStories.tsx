...
export function SuccessStories() {
  ...
  return (
    <div className="pt-20">
      <Head>
        <title>Success Stories | M7 & Top EU MBA Admits - Elite Admissions Consulting</title>
        ...
        <meta property="og:title" content="Success Stories | M7 & Top EU MBA Admits - Elite Admissions Consulting" />
        ...
        <meta property="twitter:title" content="Success Stories | M7 & Top EU MBA Admits - Elite Admissions Consulting" />
