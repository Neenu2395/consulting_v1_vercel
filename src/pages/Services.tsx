...
export function Services() {
  ...
  return (
    <div className="pt-20">
      <Head>
        <title>MBA & MS Admissions Services | Elite Admissions Consulting</title>
        ...
        <meta property="og:title" content="MBA & MS Admissions Services | Elite Admissions Consulting" />
        ...
        <meta property="twitter:title" content="MBA & MS Admissions Services | Elite Admissions Consulting" />
